function gen_config_file_v1(path)
...
prompt = {'Subject (Mouse or Phantom)','Mouse Strain:','Mouse Mass','Mouse Sex','DOB','Breath-hold type: (R for retrogating)','Num Rays to Keep','Notes:'};
name = ['Parameters for Data in File ' path];
dims = [1 250];
definput = {'Mouse','C57BL-6J','25','M',datestr(date,29),'Inspiration','0',''};
...
Notes = parameters{8,1};

close;
%% Write out parameters to text file
fileID = fopen('ConfigFile_V1.txt','w');
